(module
  (global $import_int_32 (import "env" "import_i32") i32)
  (global $import_int_64 (import "env" "import_i64") i64)
  ...
  (import "js" "log_i64" (func $log_i64 (param i64)))
  (import "js" "log_f32" (func $log_f32 (param f32)))
  (import "js" "log_f64" (func $log_f64 (param f64)))
  
  (func (export "globaltest")
    (call $log_i32 (global.get $import_int_32))
    (call $log_i64 (global.get $import_int_64))
